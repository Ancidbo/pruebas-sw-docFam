    ...
    def test_close_orders(self):
        ...
        for linea in lista:
            ...
            #Login
                ...
                modify_estatus.select_by_visible_text(close)
                time.sleep(1)
...
if __name__ == "__main__":
    unittest.main(verbosity = 2, testRunner = HTMLTestRunner(output= 'reportes',report_name= 'Medicamentos Entregados'))